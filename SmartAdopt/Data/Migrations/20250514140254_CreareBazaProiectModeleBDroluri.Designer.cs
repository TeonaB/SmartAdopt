...
namespace SmartAdopt.Data.Migrations
{
    ...
    [Migration("20250514140254_CreareBazaProiectModeleBDroluri")]
    partial class CreareBazaProiectModeleBDroluri
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartAdopt.Models.Comentariu", b =>
                {
                    ...
                    b.Property<int?>("PostareidPostare")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartAdopt.Models.RaspAnimal", b =>
                {
                    ...
                    b.Property<int?>("RaspChestionaridRasp")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RaspChestionaridRasp");
            ...
            modelBuilder.Entity("SmartAdopt.Models.Comentariu", b =>
                {
                    ...
                    b.HasOne("SmartAdopt.Models.Postare", "Postare")
                        .WithMany("Comentarius")
                        .HasForeignKey("PostareidPostare");
            ...
            modelBuilder.Entity("SmartAdopt.Models.RaspAnimal", b =>
                {
                    ...
                    b.HasOne("SmartAdopt.Models.RaspChestionar", "RaspChestionar")
                        .WithMany("RaspAnimals")
                        .HasForeignKey("RaspChestionaridRasp");
